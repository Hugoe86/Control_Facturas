...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Ope_Facturas.aspx.cs" 
    Inherits="web_cambios_procesos.Paginas.Operacion.Frm_Ope_Facturas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/operacion/Facturas/Js_Ope_Facturas.js"></script>
    <script src="../../Recursos/javascript/operacion/Facturas/Js_Ope_Facturas_Modal.js"></script>
    <script src="../../Recursos/javascript/operacion/Facturas/Js_Ope_Facturas_Historico.js"></script>
    <script src="../../Recursos/javascript/operacion/Facturas/Js_Ope_Facturas_Adjuntos.js"></script>
    <script src="../../Recursos/javascript/operacion/Facturas/Js_Ope_Facturas_Anticipo.js"></script>
    <script src="../../Recursos/javascript/operacion/Facturas/Js_Ope_Facturas_Conceptos_Xml.js"></script>
    <style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Facturas</h3>
        </div>
