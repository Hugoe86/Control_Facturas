<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Ope_Facturas_Validacion.aspx.cs" Inherits="web_cambios_procesos.Paginas.Operacion.Frm_Ope_Facturas_Validacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/operacion/Js_Ope_Facturas_Validacion.js"></script>
    <script src="../../Recursos/javascript/operacion/Validaciones/Js_Ope_Validaciones_Adjuntos.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Validaciones de Factura</h3>
        </div>
