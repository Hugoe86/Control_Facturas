...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Ope_Anticipos.aspx.cs" 
    Inherits="web_cambios_procesos.Paginas.Operacion.Frm_Ope_Anticipos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/operacion/Anticipos/Js_Ope_Anticipos.js"></script>
    <script src="../../Recursos/javascript/operacion/Anticipos/Js_Ope_Anticipos_Modal.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Anticipos</h3>
        </div>
