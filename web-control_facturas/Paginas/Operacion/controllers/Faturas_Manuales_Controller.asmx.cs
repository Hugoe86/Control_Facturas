...
{
    /// <summary>
    /// Descripción breve de Faturas_Manuales_Controller
    /// </summary>
    ...
    public class Faturas_Manuales_Controller : System.Web.Services.WebService
    {
                        ...
                        try
                        {
                            ...
                            else//  se le notificara que el valor ya se encuentra registrado
                            {
                                ...
                                mensaje.Mensaje = "<i class='" + icono + "'style = 'color:" + color + ";' ></i> &nbsp; El folio [" + obj_datos.Folio + "]" +
                                                    ...
                                                    " Concepto [" + obj_datos.Concepto_Xml + "]" +
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_Conceptos_Registrados_Manualmente_Filtros(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var consulta = (from _facturas in dbContext.Ope_Facturas
                                    ...
                                    //  folio
                                    && _facturas.Folio_Cheque.ToString() == obj_datos.Folio
        ...
        public string Consultar_Datos_Sesion(string json_object)
        {
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())
                {
                    ...
                    var _consulta = (from _usuario in dbContext.Apl_Usuarios
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_Facturas_Manualmente_Filtros(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var consulta = (from _facturas in dbContext.Ope_Facturas
                                    ...
                                    from _rechazadas in _rechazada_null.DefaultIfEmpty()
                                        ...
                                        //  Folio id
                                    where ((obj_datos.Factura_Id == 0) ? true : _facturas.Factura_Id == obj_datos.Factura_Id)
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var consulta = (from _facturas in dbContext.Ope_Facturas
                                    ...
                                    from _rechazadas in _rechazada_null.DefaultIfEmpty()
                                        ...
                                        //  Folio id
                                    where (string.IsNullOrEmpty(obj_datos.Folio) ? true : _facturas.Folio == obj_datos.Folio)
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_Datos_FolioCheque_Factura_General_Mills(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var _consulta = (from _factura in dbContext.Ope_Facturas
                                         ...
                                         //  concepto
                                     join _conceptos in dbContext.Cat_Conceptos on _factura.Concepto_Id equals _conceptos.Concepto_Id


                                     where (!String.IsNullOrEmpty(parametro) ?
                                               (_factura.Folio.Contains(parametro))
                                               : true)

                                        && _conceptos.Captura_Manual == true

                                     select new Cls_Select2
                                     {
                                         id = _factura.Folio.ToString().Trim(),
                                         text = _factura.Folio.Trim(),
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    using (var transaction = dbContext.Database.BeginTransaction())//   variable que se utiliza para la transaccion
                    {
                        try
                        {
                            ...
                            //  *********************************************************************************************************************
                            //variable para guardar la información del dato a eliminar
                            var _registro_a_eliminar = dbContext.Ope_Facturas_Anexos.Where(u => u.Anexo_Id == obj_datos.Anexo_Id).First();//    variable para contener los anexos de la factura
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_Total_Pagos_Por_Factura_Manuales(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var consulta = (from _pagos in dbContext.Ope_Facturas_Pagos
                                    ...
                                    //  factura id
                                    where (!String.IsNullOrEmpty(obj_datos.Folio) ? _factura.Folio_Cheque.ToString() == (obj_datos.Folio) : true)//
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_SubTotal_Registrado_Manualmente(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
            ...
            try
            {
                ...
                {
                    //  se realiza la consulta
                    var consulta = (from _factura in dbContext.Ope_Facturas
                                    ...
                                    select new Cls_Ope_Facturas_Negocio
                                    {
                                        Subtotal = _factura.Subtotal ?? 0,
                                    }).Sum(s => s.Subtotal).GetValueOrDefault();//   variable que almacena la consulta
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_Total_Registrado_Manualmente(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var consulta = (from _factura in dbContext.Ope_Facturas
                                    ...
                                    select new Cls_Ope_Facturas_Negocio
                                    {
                                        Total_Pagar = _factura.Total_Pagar ?? 0,
                                    }).Sum(s => s.Total_Pagar).GetValueOrDefault();//   variable que almacena la consulta
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public string Consultar_Total_Anticipos_Por_Factura_Manuales(string json_object)
        {
            //  declaración de variables
            Cls_Ope_Facturas_Negocio obj_datos = new Cls_Ope_Facturas_Negocio();//  variable de negocio que contendrá la información recibida
            string json_resultado = "";//    variable para contener el resultado de la operación
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    using (var transaction = dbContext.Database.BeginTransaction())//   variable que se utiliza para la transaccion
                    {
                        try
                        {
                            ...
                            //  *********************************************************************************************************************
                            //variable para guardar la información del dato a eliminar
                            var _registro_a_eliminar = dbContext.Ope_Facturas_Anticipos.Where(u => u.Anticipo_Factura_Id == obj_datos.Anticipo_Factura_Id).First();//   variable para los anticipos eliminados
                            dbContext.Ope_Facturas_Anticipos.Remove(_registro_a_eliminar);
        ...
        public Cls_Mensaje Exportar_Datos_Pdf(Cls_Ope_Facturas_Negocio obj_datos, iTextSharp.text.Document documento_pdf, Cls_Mensaje mensaje)
        {
            ...
            try
            {
                ...
                letras_valor.MascaraSalidaDecimal = "00/100 DÓLARES AMERICANO";
                letras_valor.SeparadorDecimalSalida = "CON";
