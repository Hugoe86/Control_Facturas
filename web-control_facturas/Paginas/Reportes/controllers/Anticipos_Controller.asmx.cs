...
{
    /// <summary>
    /// Descripción breve de Anticipos_Controller
    /// </summary>
    ...
    public class Anticipos_Controller : System.Web.Services.WebService
    {
                ...
                using (var dbContext = new Entity_CF())// variable que almacena la informacion del entity
                {
                    ...
                    var consulta = (from _facturas in dbContext.Ope_Facturas
                                    ...
                                    from _conceptoNull in _concepto_null.DefaultIfEmpty()
                                        ...
                                        //  anticipos
                                    join _anticipos in dbContext.Ope_Facturas_Anticipos on _facturas.Factura_Id equals _anticipos.Factura_Id into _anticipo_null
                                    from _anticipoNull in _anticipo_null.DefaultIfEmpty()
                                    ...
                                    //  anticipos
                                    && ((obj_datos.Anticipo_Id > 0) ? _anticipoNull.Anticipo_Id == (obj_datos.Anticipo_Id) : true)
        ...
        public Cls_Mensaje Genere_PDF(string json_object)
        {
            ...
            try
            {
                ...
                string nombre_archivo = "Anticipos_" + fecha_formato_string + ".pdf";//    variable en la que se establece el nombre del archvo que se generara
                string ruta_archivo = Server.MapPath("../../../Reportes/Anticipos/") + nombre_archivo;//  variable el que se obtiene la ruta del archivo generado
                //  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                //  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                mensaje.Url_PDF = "../../Reportes/Anticipos/" + nombre_archivo;
                //  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                //  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        ...
        public Cls_Mensaje Genere_Excel(string json_object)
        {
            ...
            try
            {
                ...
                string nombre_archivo_inicial = "Anticipos_" + obj_datos.Folio + "_" + fecha + ".xlsx";//   variable para el nombre del archivo
                string ruta_archivo = Server.MapPath("../../../Reportes/Anticipos/") + nombre_archivo_inicial;//    variable para la ruta del archivo
                //  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                //  <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                ...
                string nombre_archivo = "Anticipos_" + obj_datos.Folio + "_" + fecha + ".xlsx";//    variable para el nombre del archivo

                carpeta_final = Obtener_Carpeta_Destino("Anticipos");
                ...
                using (ExcelPackage excel_doc = new ExcelPackage(template, true))// variable para establecer las propiedades del excel
                {
                    ...
                    using (var dbContext = new Entity_CF())// variable con la que se carga la esctructura del entity
                    {
                        ...
                        ExcelWorksheet detalle_excel = excel_doc.Workbook.Worksheets.Add("Anticipos");//  variable en el que se carga una pagina de excel
                        ...
                        detalle_excel.Cells["A1"].Value = "Relación de Anticipos con Facturas y Totales";
                        ...
                        if (consulta.Any())
                        {
                            ...
                            foreach (var registro in consulta)//    variable para obtener los datos del renglon de la consulta
                            {
                                ...
                                //  encabezados de la tabla
                                detalle_excel.Cells["V" + Cont_Filas + ":" + columna_tope + Cont_Filas].Style.Font.Bold = true;
                                detalle_excel.Cells["V" + Cont_Filas].Value = "Anticipo";
                                ...
                                detalle_excel.Cells["W" + Cont_Filas].Value = "Monto Anticipo";
                                ...
                                if (consulta_anticipos.Any())
                                {
                                    ...
                                    foreach (var registro_anticipo in consulta_anticipos)//  variable con la que se obtien los datos de la lista
                                    {
                                        ...
                                        #region estructura detalle anticipo
                                        detalle_excel.Cells["V" + (Cont_Filas + Cont_Anticipos)].Value = registro_anticipo.Anticipo;
                                        detalle_excel.Cells["V" + (Cont_Filas + Cont_Anticipos)].Style.Border.Left.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["V" + (Cont_Filas + Cont_Anticipos)].Style.Border.Right.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["V" + (Cont_Filas + Cont_Anticipos)].Style.Border.Bottom.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["V" + (Cont_Filas + Cont_Anticipos)].Style.Border.Top.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;

                                        detalle_excel.Cells["W" + (Cont_Filas + Cont_Anticipos)].Value = registro_anticipo.Monto;
                                        detalle_excel.Cells["W" + (Cont_Filas + Cont_Anticipos)].Style.Border.Left.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["W" + (Cont_Filas + Cont_Anticipos)].Style.Border.Right.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["W" + (Cont_Filas + Cont_Anticipos)].Style.Border.Bottom.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["W" + (Cont_Filas + Cont_Anticipos)].Style.Border.Top.Style = OfficeOpenXml.Style.ExcelBorderStyle.Thin;
                                        detalle_excel.Cells["W" + (Cont_Filas + Cont_Anticipos)].Style.Numberformat.Format = "#,##0.00";
                ...
                mensaje.Ruta_Archivo_Excel = "../../Reportes/Anticipos/" + nombre_archivo_inicial; ;
