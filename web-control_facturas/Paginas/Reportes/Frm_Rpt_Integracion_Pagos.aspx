...
<%@ Page Language="C#"
    ...
    CodeBehind="Frm_Rpt_Integracion_Pagos.aspx.cs"
    Inherits="web_cambios_procesos.Paginas.Reportes.Frm_Rpt_Integracion_Pagos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/reportes/Integracion_Pagos/Js_Rpt_Integracion_Pagos.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Integraciones de pagos</h3>
        </div>
