...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Cat_Validaciones.aspx.cs" 
    Inherits="web_cambios_procesos.Paginas.Catalogos.Frm_Cat_Validaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Validacion/Js_Cat_Validaciones.js"></script>
    <script src="../../Recursos/javascript/catalogos/Validacion/Js_Cat_Validaciones_Modal.js"></script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Validaciones</h3>
        </div>
