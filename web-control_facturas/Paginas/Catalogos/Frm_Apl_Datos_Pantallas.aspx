<%@ Page Title="Datos de Pantallas" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Apl_Datos_Pantallas.aspx.cs" Inherits="web_cambios_procesos.Paginas.Catalogos.Frm_Apl_Datos_Pantallas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Apl_Datos_Pantallas.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height:100vh;">

        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Dato</h3>
        </div>
            ...
            <div class="panel-body">
                <div class="row">
                      <div class="col-md-1" style="margin-top: 8px;">
                        <label class="fuente_lbl_controles">Dato</label>
                    </div>
                    <div class="col-md-3">
                        <input type="text" id="txt_busqueda_por_dato" class="form-control" placeholder="Búsqueda por Dato" />
                    </div>
                    <div class="col-md-8">
        ...
        <table id="tbl_datos" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>
