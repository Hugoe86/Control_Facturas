    ...
    public class Empresas_Controller : System.Web.Services.WebService
    {
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())
                {
                    var Empresas = (from _empresas in dbContext.Apl_Empresas
                                    join _estatus in dbContext.Apl_Estatus on _empresas.Estatus_ID equals _estatus.Estatus_ID
                                    where
            ...
            try
            {
                ...
                using (var dbContext = new Entity_CF())
                {
                    ...
                    foreach (var p in Roles)
                    {
                        ...
                        using (var dbContext2 = new Entity_CF())
                        {
        ...
        private void Alta_Usuario(int Parametro_Empresa_ID, int Parametro_Estatus_ID, int Paremetro_Sucursal_ID)
        {
            ...
            try
            {
                ...
                using (var dbContext3 = new Entity_CF())
                {
