<%@ Page Title="Catálogo de Puestos" Language="C#" MasterPageFile="~/Paginas/Paginas_Generales/MasterPage.Master" AutoEventWireup="true" CodeBehind="Frm_Cat_Puestos.aspx.cs" Inherits="web_cambios_procesos.Paginas.Catalogos.Frm_Cat_Puestos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Puestos.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table id="tbl_puestos" data-toolbar="#toolbar" class="table table-responsive"></table>
    </div>
</asp:Content>
