...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Cat_Areas.aspx.cs" 
    Inherits="web_cambios_procesos.Paginas.Catalogos.Frm_Cat_Areas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Areas/Js_Cat_Areas.js"></script>
    <script src="../../Recursos/javascript/catalogos/Areas/Js_Cat_Areas_Modal.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">&Aacute;reas</h3>
        </div>
