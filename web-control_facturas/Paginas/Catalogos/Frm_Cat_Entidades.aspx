...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Cat_Entidades.aspx.cs" 
    Inherits="web_cambios_procesos.Paginas.Catalogos.Frm_Cat_Entidades" %>
<%-- --------------------------------------------------------------------------------------------------------------------------------------- --%>
<%-- --------------------------------------------------------------------------------------------------------------------------------------- --%>
<%-- --------------------------------------------------------------------------------------------------------------------------------------- --%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Entidades/Js_Cat_Entidades.js"></script>
    <script src="../../Recursos/javascript/catalogos/Entidades/Js_Cat_Entidades_Modal.js"></script>
    <script src="../../Recursos/javascript/catalogos/Entidades/Js_Cat_Entidades_Relacion.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Entidades</h3>
        </div>
