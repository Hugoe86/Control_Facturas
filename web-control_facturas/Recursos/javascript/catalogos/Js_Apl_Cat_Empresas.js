...
/* =============================================
--NOMBRE_FUNCIÓN: _modificar_empresas
...
/* =============================================
--NOMBRE_FUNCIÓN: _eliminar_empresas
--DESCRIPCIÓN: Metodo para enviar los datos a eliminar
--PARÁMETROS: empresa_id.- el id del dato a eliminar
--CREO: Saul Jonathan Marquez Martinez
--FECHA_CREO: 06 de Agosto del 2019
--MODIFICÓ:
--FECHA_MODIFICÓ:
...
function _modal() {
    ...
    try {
        ...
        tags +=
            ...
            '        <input type="text" id="txt_cp" name="txt_cp" class="form-control input-sm" disabled="disabled" placeholder="Código Postal" data-parsley-required="false" maxlength="20" /> ' +
            '    </div>' +
            '</div>' +
...
--PARÁMETROS: empresas.- carga los datos a modificar
--CREO: Saul Jonathan Marquez Martinez
--FECHA_CREO: 06 de agosto del 2019
--MODIFICÓ:
--FECHA_MODIFICÓ:
...
--PARÁMETROS: empresas.- carga los datos a eliminar
--CREO: Saul Jonathan Marquez Martinez
--FECHA_CREO: 06 de Agosto del 2019
--MODIFICÓ:
--FECHA_MODIFICÓ:
...
/* =============================================
--NOMBRE_FUNCIÓN: _load_entidad_empresa
--DESCRIPCIÓN: Metodo para cargar datos de empresas
--PARÁMETROS: N/A
--CREO: Saul Jonathan Marquez Martinez
--FECHA_CREO: 06 de Agosto del 2019
--MODIFICÓ:
