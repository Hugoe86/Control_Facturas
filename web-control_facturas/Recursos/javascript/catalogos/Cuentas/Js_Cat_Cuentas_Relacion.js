...
function _launch_modal_relacion(title_window) {
    ...
    //  se muestra el modal
    jQuery('#modal_cuentas_relacion').modal('show', { backdrop: 'static', keyboard: false });
}
...
function _set_close_modal_relacion() {
    //  cierra el modal
    jQuery('#modal_cuentas_relacion').modal('hide');
}
...
function _consultar_relacion() {
    ...
    try {
       ...
       filtros.Cuenta_Id = parseInt($('#txt_cuenta_relacion_id').val());
       filtros.Entidad_Id = 0;
        ...
        jQuery.ajax({
            ...
            success: function (datos) {
                ...
                if (datos !== null) {
                    ...
                    $('#tbl_relacion_cuenta').bootstrapTable('load', JSON.parse(datos.d));
                }
            }
        });
...
function _load_cmb_entidad(cmb) {
    try {
        ...
        $('#' + cmb).select2({
            ...
            allowClear: true,
            ajax: {
                url: 'controllers/Cuentas_Controller.asmx/Consultar_Entidades_Catalogo_Combo',
                cache: true,
                dataType: 'json',
                type: "POST",
                delay: 250,
...
function alta_relacion() {
    ...
    try {
        ...
        //  se carga la información 
        obj.Cuenta_Id = parseInt($('#txt_cuenta_relacion_id').val());
        obj.Entidad_Id = parseInt($('#cmb_entidad :selected').val());
...
function crear_tabla_relacion() {
    ...
    try {
        ...
        $('#tbl_relacion_cuenta').bootstrapTable('destroy');

        //  se carga la estructura que tendrá la tabla
        $('#tbl_relacion_cuenta').bootstrapTable({
            cache: false,
            striped: true,
            pagination: true,
            data: [],
            ...
            columns: [
                ...
                { field: 'Cuenta', title: 'Cuenta', align: 'left', valign: 'top', width: 150, visible: false, sortable: true },
