...
function _load_vistas() {
    ...
    _launchComponent('vistas/Facturas_Manual/Principal.html', 'Principal');
    _launchComponent('vistas/Facturas_Manual/Modal.html', 'Modal');
    _launchComponent('vistas/Facturas_Manual/Historico.html', 'Historico');
    _launchComponent('vistas/Facturas_Manual/Adjuntar.html', 'Adjuntar');
    _launchComponent('vistas/Facturas_Manual/Anticipo.html', 'Anticipo');
...
function _inicializar_vista_modal() {
    try {
        ...
        _keyDownInt('txt_subtotal');
        _keyDownInt('txt_iva');
        _keyDownInt('txt_retencion');
...
function _consultar_parametros() {
    ...
    try {
        ...
        jQuery.ajax({
            type: 'POST',
            url: 'controllers/Faturas_Manuales_Controller.asmx/Consultar_Parametros',
            data: $data,
...
function _consultar_datos_usuario() {
    ...
    try {
        ...
        jQuery.ajax({
            type: 'POST',
            url: 'controllers/Faturas_Manuales_Controller.asmx/Consultar_Datos_Sesion',
            data: $data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
            ...
            success: function (datos) {
                ...
                if (datos !== null) {
                    ...
                    //  se valida que la operacion sea exitosa
                    if (result.Estatus == "success") {
                        Permiso_Captura = true;

                    }
                    //  validamos que la operacion tenga algun error
                    else {
...
function _inicializar_icheck() {
    ...
    /* =============================================
    --NOMBRE_FUNCIÓN:       $('input.icheck-11').iCheck('destroy')
    --DESCRIPCIÓN:          Destruye todos los controles correspondientes a icheck11
    --PARÁMETROS:           NA
    --CREO:                 Hugo Enrique Ramírez Aguilera
    --FECHA_CREO:           14 Abril de 2020
    --MODIFICÓ:
    ...
    /* =============================================
    --NOMBRE_FUNCIÓN:       $('input.icheck-11').iCheck
    --DESCRIPCIÓN:          Se asignan las propiedades a los controles
    --PARÁMETROS:           NA
    --CREO:                 Hugo Enrique Ramírez Aguilera
    --FECHA_CREO:           14 Abril de 2020
    --MODIFICÓ:
...
function expandir_tabla($detail, row) {
    ...
    //  se crea la tabla detalle de las facturas
...
function crear_tabla_principal_detalle($tabla, rows) {
    ...
    try {
        ...
        $.ajax({
            type: 'POST',
            url: 'controllers/Faturas_Manuales_Controller.asmx/Consultar_Facturas_Filtros',
            data: $data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
        ...
        $tabla.bootstrapTable({
            ...
            columns: [
                ...
                { field: 'Concepto_Texto_Id', title: 'Tipo de Concepto', width: 110, align: 'left', valign: 'top', visible: true },
                { field: 'Folio', title: 'Referencia', align: 'left', valign: 'top', width: 50, visible: true, sortable: true, },
                { field: 'Concepto_Xml', title: 'Concepto', width: 250, align: 'left', valign: 'top', visible: true },
                { field: 'Pedimento', title: 'Pedimento', width: 150, align: 'left', valign: 'top', visible: true },
                ...
                { field: 'Estatus', title: 'Estatus', align: 'left', valign: 'top', width: 70, visible: false, sortable: true, },
...
function _load_cmb_filtro_nombre(cmb) {
    try {
        ...
        $('#' + cmb).select2({
            ...
            allowClear: true,
            ajax: {
                url: 'controllers/Faturas_Manuales_Controller.asmx/Consultar_Facturas_Nombre_Combo',
                cache: true,
                dataType: 'json',
                type: "POST",
                delay: 250,
...
function _load_cmb_filtro_estatus(cmb) {
    try {
        ...
        $('#' + cmb).select2({
            ...
            allowClear: true,
            ajax: {
                url: 'controllers/Faturas_Manuales_Controller.asmx/Consultar_Facturas_Estatus_Combo',
                cache: true,
                dataType: 'json',
                type: "POST",
                delay: 250,
...
--CAUSA_MODIFICACIÓN:
=============================================*/
function _habilitar_controles_folio(opc) {
    ...
    try {
        ...
        switch (opc) {
            case 'Mostrar':
                //  se le otorga el nombre de guardar
                $('#div_folio_texto').show();
                $('#div_folio_combo').show();
                break;

            case 'Texto':
                //  se le otorga el nombre de actualizar
                $('#div_folio_texto').show();
                $('#div_folio_combo').hide();
                break;

            case 'Combo':
                //  se le otorga el nombre de actualizar
                $('#div_folio_texto').hide();
                $('#div_folio_combo').show();
                break;
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controllers/Faturas_Manuales_Controller.asmx/Enviar_Validacion',
                        data: $data,
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        async: false,
...
function btn_editar_click(tab) {
    ...
    $('#cmb_folio').select2("trigger", "select", {
        data: { id: row.Folio, text: row.Folio_Filtro }
    });
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'controllers/Faturas_Manuales_Controller.asmx/EliminarConcepto',
                    data: $data,
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    async: false,
...
function btn_nuevo_concepto_click(tab) {
    ...
    $('#cmb_tipo_concepto').prop('disabled', true);

    _cargar_datos_principales_(row.Folio);
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'controllers/Faturas_Manuales_Controller.asmx/Autorizacion',
                        data: $data,
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        async: false,
                    ...
                    bootbox.prompt({
                        ...
                        callback: function (resultado_) {
                            ...
                            if (resultado_) {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: 'controllers/Faturas_Manuales_Controller.asmx/Rechazar',
                                    data: $data,
                                    dataType: "json",
                                    contentType: "application/json; charset=utf-8",
                                    async: false,
...
function _consultar_folio_cheque() {
    ...
    try {
        ...
        jQuery.ajax({
            type: 'POST',
            url: 'controllers/Faturas_Manuales_Controller.asmx/Consultar_Folio_Solicitud_Cheque',
            data: $data,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            async: false,
