...
function _load_vistas() {
    ...
    _launchComponent('vistas/Plantillas/Principal.html', 'Principal');
    _launchComponent('vistas/Plantillas/Anticipo.html', 'Anticipo');
    _launchComponent('vistas/Plantillas/Pagos.html', 'Pagos');
...
function _consultar_informacion() {
    ...
    try {
        ...
        jQuery.ajax({
            type: 'POST',
            url: 'controllers/Conceptos_Controller.asmx/Consultar_Plantilla_Filtros',
            data: $data,
...
function _generar_pdf() {
    ...
    try {
        ...
        $.ajax({
            type: 'POST',
            url: 'controllers/Conceptos_Controller.asmx/Genere_PDF',
            data: $data,
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            async: false,
...
function _generar_excel() {
    ...
    try {
        ...
        $.ajax({
            type: 'POST',
            url: 'controllers/Conceptos_Controller.asmx/Genere_Excel',
            data: $data,
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            async: false,
